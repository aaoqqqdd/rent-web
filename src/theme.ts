...
.guide-facts { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); max-width: 680px; margin-top: 34px; border: 1px solid var(--border); background: rgba(8,10,16,.42); }
